 <?php
    ...
    echo "pedido escolhido foi: $pedidoSelecionado";
...
VALUES ($pedidoSelecionado, (SELECT ip.num_seq_item + 1 AS increment_num_seq_item
    ...
    // showArray($resultado_update_item_modificado);
             ...
             <table class="tabela table table-bordered table-responsive" border="1">
                 ...
                 <tr>
                     <td colspan="2">
                         ...
                         <a class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" href="cadastro_item.php">Cadastrar um novo item?</a>
                     </td>
                 </tr>
             </table>
         </form>
