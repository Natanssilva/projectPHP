...
if (isset($_POST['salvar_pedido'])) {
    ...
    $response = [  //array associativo pra retornar como json , caso seja sucesso vai retornar 1 por ser boolean
        'sucess' =>  true,     
        'message' => "<p class='text-success'>Pedido criado com sucesso! Número do pedido: " . $numero_pedido_inclusao . "</p>"
    ];
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="mb-3">
                            <label for="clienteNovo" class="form-label">Cliente novo?</label>
                            <a href="cadastro_cliente.php" class="btn btn-link">Cadastrar cliente</a>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            if (!empty($resultado_inclusao)) {
                                // Número do pedido pela inclusão de pedido
                                $numero_pedido_inclusao = $ligacao->lastInsertId();
                                echo "<p class='text-success'>Pedido criado com sucesso! Número do pedido: " . $numero_pedido_inclusao . "</p>";
                            } else {
