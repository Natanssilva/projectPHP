                    ...
                    <div class="card-body">
                        ...
                        <form action="cadastro_item.php" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="nome_item" class="form-control" id="nome" placeholder="Digite o nome do item" required>
                                <label for="nome">Valor do item:</label>
                                <input type="number" name="valor_item" class="form-control" id="nome" min="1" step=".01" required>
                            </div>
