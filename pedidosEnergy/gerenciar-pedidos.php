    ...
    <?php require_once 'connect.php'; ?>
        <?php foreach ($pedido_nome_cliente as $pedido_cliente) { ?>
            <table class="tabela" border="1">
                ...
                <?php while ($item_pedido = $resultado_item ->fetch()) { ?>
                    
                
                <tr>
                <td><?php echo $item_pedido['den_item']; ?></td>
                    <td><?php echo $item_pedido['qtd_solicitada']; ?></td>
                    <td><?php echo $item_pedido['pre_unitario']; ?></td>
                </tr>
        <?php } ?>
