                ...
                <tr>
                    ...
                    <th colspan="2">
                        <form action="controlar_item_pedido.php" method="post">
                            ...
                            <input type="submit" class="btn btn-outline-primary" value="INCLUIR PEDIDO">
                        </form>
                        <br>
            ...
            ?>
                ...
                <tr>
                    ...
                    <td><?php echo "R$ " .  number_format($value['total_itens'], 2);
                        ...
                        ?></td>
                     <td>
                        <a href="controlar_pedido.php?numero_pedido=<?php echo ($pedido_cliente['num_pedido']) ?> ">[MODIFICAR ITEM]</a>
                    </td>
                    <td>
                        <a href="#">[EXCLUIR]</a>
                    </td>
