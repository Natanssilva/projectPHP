...
if (isset($_POST['salvar_novo_item'])) {
    ...
    if (!empty($item_igual)) {   //ponto a melhoar : verificar caracteres especiais pra evitar sql injection
...
// else {
//     $msg_envio = "<span class = 'text-danger'>[ERRO] Formulário nao foi enviado! </span>";
// }
