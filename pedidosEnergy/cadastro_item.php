<?php
 ...
 $query_prox_cod_item = "SELECT MAX(cod_item) AS max_cod_item FROM item;";
 $resultado_prox_cod_item = $ligacao ->query($query_prox_cod_item);
 $max_proximo_cod_item = $resultado_prox_cod_item ->fetch();

 $max_cod_item = $max_proximo_cod_item['max_cod_item']; //pegando o maior valor do cod_item (o ultimo)
