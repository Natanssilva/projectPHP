...
<body class="container">
    ...
    <table class="tabela table table-bordered table-responsive" border="1">
        ...
        <tr>
            <td>Item:</td>
            <td colspan="2">
                    <select name="itens" id="" required>
                            <option value=""></option>
                            <?php  foreach ($itens_disponiveis as $value) { ?>
                                <option value="<?php ($value['den_item']) ?>"><?php echo ($value['den_item']) ?></option>
                            <?php } ?>
                    </select>
            </td>
        ...
        <tr>
            <td>Qtd:</td>
        <td>
        <select name="QtdSelecionada" id="id" required>
            <option value=""></option>
                <?php for ($i = 1; $i <= 10; $i++) { ?>
