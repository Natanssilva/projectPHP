...
echo "<br>$numero_pedido_incluir";
echo "<br>$item_selecionado";
echo "<br>$qtd_solicitada";
echo "<br>$cod_item";
// showArray($itens_disponiveis);
    ...
    $resultado_increment_seq = $ligacao ->query($query_increment_seq);
    
    showArray($increment_num_seq);
    ...
    <form action="controlar_item_pedido.php" method="post">
        <table class="tabela table table-bordered table-responsive" border="1">
                ...
                <td colspan="2">
                        <select class="form-select form-select-sm" name="itens" id="" required>
                                ...
                                <?php  foreach ($itens_disponiveis as $value) { ?>
                                    <option value="<?php echo($value['den_item']) ?>"><?php echo ($value['den_item'])  ?></option>
                                <?php } ?>
                        </select>
                </td>
            ...
            <tr>
                ...
                <input type="hidden" name="cod_item" value="<?php echo $itens_disponiveis; ?>">
