...
if (isset($_POST['submit_incluir_item'])) {
 ...
 $query_inclusao_pedidos = 'SELECT p.num_pedido, p.cod_cliente, c.nom_cliente 
 FROM pedido AS p 
 JOIN cliente AS c 
...
$query_novo_cliente = "INSERT INTO pedido (";
...
<body class="container">
    ...
    <table class="tabela table table-bordered table-responsive" border="1">
        ...
        <th colspan="2">
            <select class="form-select form-select-sm" name="clientes_existentes" id="" required>
                <option value=""></option>
                    ...
                    <option value="<?php echo $cliente_pedido['nom_cliente'] ?>"><?php  echo $cliente_pedido['nom_cliente']  ?></option>
        ...
        <tr>
            ...
            <th colspan="2">
                <input class="form-control" type="text" name="novo_cliente" id="" required>
            </th>
        </tr>
